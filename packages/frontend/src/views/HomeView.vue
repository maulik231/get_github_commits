<template>
  <div class="container">
    <div class="row">
      <b-card class="col-12 card text-left shadow rounded">
        <b-form @submit="onSubmit" @reset="onReset">
          <b-form-group id="input-group-2" label-size="lg" label="Your Repo URL:" label-for="input-2" description="please enter only public repo URL">
            <b-form-input
              id="input-2"
